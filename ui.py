...
class UI:
    def __init__(self):
        ...
        self.values['Encoder_RA'] = '0'
        self.values['Encoder_DEC'] = '0'
        #self.values['Last'] = ''
        ...
        sg.Text('1', pad=((21, 0), 0), font='Any 15', key='Encoder_RA', relief = sg.RELIEF_RIDGE, size=(12,0), justification='right')],

        [sg.Text('Encoder_DEC', pad=((11, 0), 0), font='Any 15', key='outputz6', size=(14,0)),
        sg.Text('1', pad=((21, 0), 0), font='Any 15', key='Encoder_DEC', relief = sg.RELIEF_RIDGE, size=(12,0), justification='right')],

        #[sg.VerticalSeparator(pad=(0,15))],

        #[
        #sg.Text('1', pad=((21, 0), 0), font='Any 15', key='Last', relief = sg.RELIEF_RIDGE, size=(52,0), justification='right')],
        ]
